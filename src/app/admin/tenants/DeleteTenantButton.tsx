                        ...
                        <div className="px-6 pt-6 pb-4 text-center space-y-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm mt-1">
                                    Eliminarás permanentemente <span className="text-white font-semibold">&ldquo;{tenantName}&rdquo;</span>
                                </p>
                            </div>
                        </div>

                        {/* Warning */}
                        <div className="mx-6 mb-4 bg-red-950/50 border border-red-800/60 rounded-xl p-3 text-center">
                            <p className="text-red-300 text-xs font-bold uppercase tracking-wider">Esta acción es irreversible</p>
                            <p className="text-red-200/60 text-xs mt-1 leading-snug">
                                Mesas, usuarios, socios, historial de sesiones, pagos y configuraciones serán eliminados.
                            </p>
                        </div>

                        {/* Error */}
                        {error && (
                            <div className="mx-6 mb-4 bg-red-900/30 border border-red-700/60 rounded-lg p-3">
